...
#import rewquired packages for analysis
...
zip_demos = pd.read_csv('c_demograhs.csv')
...
#add median income column adn replace empty valies with 0
...
#save demographics per ZIP code csv

medians.to_csv("demographics_per_zip.csv", index= False)



#isolated csv generation for population per zip code from census API
