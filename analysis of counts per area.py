...
#build buffers around 

#point_list = [sewers, OWTS, WWTPs]  
#for a in point_list: 
 #   join = gpd.sjoin(a, land_dissolve, how="left", op="within")

     #count points per land use
  #  sewers_per_land = join.groupby('land_dissolve')['a'].count()

   # sewers_per_land.to_csv('a_per_land.csv")
